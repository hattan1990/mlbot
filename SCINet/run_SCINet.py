...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='BTC2', choices=['BTC','ETTh1', 'ETTh2', 'ETTm1'], help='name of dataset')
...
def run_various_periods():
    for ii in range(args.itr):
        date_range1 = ['2022-01-01 00:00', '2022-02-01 00:00',
                       '2022-03-01 00:00', '2022-04-01 00:00']
        date_range2 = ['2023-04-01 00:00', '2023-05-01 00:00',
                       '2023-06-01 00:00', '2023-07-01 00:00',
                       '2023-08-01 00:00', '2023-09-01 00:00',
                       '2023-10-01 00:00']
        ...
        for i in range(len(date_range1)):
            for j in range(1):
                ...
                exp = Exp(args)  # set experiments
                print('>>>>>>>start training : {}>>>>>>>>>>>>>>>>>>>>>>>>>>'.format(setting))
                print('Train Time Range from:{} to:{}'.format(args.date_period1, args.date_period2))
                print('Val Time Range from:{} to:{}'.format(args.date_period2, args.date_period3))
                exp.train(setting)

                if args.date_period3 != '2023-10-01 00:00':
                    print('>>>>>>>testing : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
